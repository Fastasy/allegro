        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 text-center lg:text-left space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15]">
              Stop Losing <span className="gradient-text-accent">Port Elizabeth</span> Customers To Competitors On Google.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-3">
              <button
                ...
                className="w-full sm:w-auto shimmer-btn text-black font-black text-base px-8 py-4 rounded-xl shadow-xl hover:scale-[1.03] active:scale-[0.98] transition-all flex items-center justify-center gap-3 cursor-pointer group border border-yellow-300"
              >
